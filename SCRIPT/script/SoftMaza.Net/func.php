...
break;
if($page!=$i)
$list.='<a href="http://softmaza.net/'.$dir.'/'.$p.'/'.$sort.'/'.$i.'.html">'.($i+1).'</a>|';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://softmaza.net/'.$dir.'/'.$p.'/'.$sort.'/'.$n.'.html">'.($n+1).'</a>|';
else
$list.=($n+1).'|';
}
$next=$n;
...
break;
if($page!=$i)
$list.='<a href="http://softmaza.net/'.$dir.'/'.$p.'/'.($i+1).'/'.$sort.'.html">'.($i+1).'</a>|';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://softmaza.net/'.$dir.'/'.$p.'/'.$sort.'/'.($n+1).'.html">'.($n+1).'</a>|';
else
$list.=($n+1).'|';
}
$next=$n;
