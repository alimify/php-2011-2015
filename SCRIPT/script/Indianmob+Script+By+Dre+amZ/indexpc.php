...
$tx=urlencode($dirt);
print '<div class="multiple_columns"><div class="special">'.$ico.' <br/><strong><a href="p'.$tx.'.html">'.transdir($dir_exp[count($dir_exp)-1]).'</a><strong><br/><div class="wln" style="font-size: 12px;"><font color="#2E7908">('.$tot.')</div></div></div>';}

else {

$dirt=str_replace('/','_',$dirt);  
$tx=urlencode($dirt);
print '<div class="multiple_columns"><div class="special">'.$ico.' <br/><strong><a href="p_'.$tx.'.html">'.transdir($dir_exp[count($dir_exp)-1]).'</a><strong><br/><div class="wln" style="font-size: 12px;"><font color="#2E7908">('.$tot.')</div></div></div>';}
...
$fx=urlencode($fff);
print '<div class="multiple_columns"><div class="special">'.$thumb.'<br/><a href="pc'.$fx.'.html"><strong>'.$basename.' </strong></a><br/><div class="wln" style="font-size: 12px;"><font color="#2E7908">('.$filesize.')</font><br/><font color="#aa0000">Downloaded '.$hit.'</font></div></div></div>';
...
$fff=str_replace('/','_',$fff);  
$fx=urlencode($fff);
print '<div class="multiple_columns"><div class="special">'.$thumb.'<br/><a href="pc_'.$fx.'.html"><strong>'.$basename.' </strong></a><br/><div class="wln" style="font-size: 12px;"><font color="#2E7908">('.$filesize.')</font><br/><font color="#aa0000">Downloaded '.$hit.'</font></div></div></div>';
...
$current=''.$page.'&nbsp;';
if ($prev>0) $pgprev='<a href="pcx_'.$dirx.'_'.$prev.'.html">'.$prev.'</a>&nbsp;';
if ($next<$countstr) $pgnext='<a href="pcx_'.$dirx.'_'.$next.'.html">'.$next.'</a>&nbsp;';
if($page>2) $first='<a href="pcx_'.$dirx.'_1.html">1</a>&nbsp;';
if($page<$countstr) $pglast='<a href="pcx_'.$dirx.'_'.$countstr.'.html">'.$countstr.'</a>&nbsp;';
...
$g[$i]= '<a class="on" href="p_'.join('_', $j).'.html"><span class="">'.transdir($u).'</span></a>';
