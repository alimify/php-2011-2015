...
class updatesActions extends sfActions
{
  ...
  public function executeActivation()
  {
    ...
    $c->save();
  	if($this->getRequestParameter('status') == 'D')
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/skyadnin/updates/activation/id/'.$this->getRequestParameter('id').'/status/A\', {asynchronous:true, evalScripts:false});; return false;" href="#">Active</a>';
  	else
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/skyadnin/updates/activation/id/'.$this->getRequestParameter('id').'/status/D\', {asynchronous:true, evalScripts:false});; return false;" href="#">Deactive</a>';
		return sfView::NONE;
  }
