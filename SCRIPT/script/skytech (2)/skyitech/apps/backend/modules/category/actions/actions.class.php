...
class categoryActions extends sfActions
{
  ...
  {
		if(!stristr($_SERVER['HTTP_HOST'],'skymp3.in'))
			if(!stristr($_SERVER['HTTP_HOST'],'skymp3.sky'))
				exit;
		...
		*/
		...
		if($this->getRequest()->getFileSize('thumb_name') > 0)
		{
...

			{
				...
				myClass::getImageRatio($this->getRequest()->getFilePath('thumb_name'),'thumb/c/',70, 80, $width1, $height1,false, $category->getId().'_1.jpg',true,90,'logo_v.png');
				myClass::getImageRatio($this->getRequest()->getFilePath('thumb_name'),'thumb/c/',150, 150, $width1, $height1,false, $category->getId().'_2.jpg',true,90,'logo_2.png');
				myClass::getImageRatio($this->getRequest()->getFilePath('thumb_name'),'thumb/c/',200, 200, $width1, $height1,false, $category->getId().'_3.jpg',true,90,'logo_200.png',$position);
				myClass::getImageRatio($this->getRequest()->getFilePath('thumb_name'),'thumb/c/',400, 400, $width1, $height1,false, $category->getId().'_4.jpg',true,90,'logo_400.png',$position);
			}
		...
		elseif($this->getRequestParameter('thumb_url_path'))
		{
			...
			fclose($outfile);
			{
				...
				myClass::getImageRatio($thumbSave,'thumb/c/',70, 80, $width1, $height1,false, $category->getId().'_1.jpg',true,90,'logo_v.png');
				myClass::getImageRatio($thumbSave,'thumb/c/',150, 150, $width1, $height1,false, $category->getId().'_2.jpg',true,90,'logo_2.png');
				myClass::getImageRatio($thumbSave,'thumb/c/',200, 200, $width1, $height1,false, $category->getId().'_3.jpg',true,90,'logo_200.png',$position);
				myClass::getImageRatio($thumbSave,'thumb/c/',400, 400, $width1, $height1,false, $category->getId().'_4.jpg',true,90,'logo_400.png',$position);
			}
		}
  ...
  public function executeActivation()
  {
    ...
    $c->save();
  	if($this->getRequestParameter('status') == 'B')
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/skyadnin/category/activation/id/'.$this->getRequestParameter('id').'/status/A\', {asynchronous:true, evalScripts:false});; return false;" href="#">Active</a>';
  	else
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/skyadnin/category/activation/id/'.$this->getRequestParameter('id').'/status/B\', {asynchronous:true, evalScripts:false});; return false;" href="#"><span class="red">Block</span></a>';
		return sfView::NONE;
  }
