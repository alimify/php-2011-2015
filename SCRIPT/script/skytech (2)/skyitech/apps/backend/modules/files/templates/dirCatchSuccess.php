	...
	<script type="text/javascript">
		...
		function makeDir(id,cid,newName,removeFile,mp3tags){
			//alert(category);
				...
				//alert("http://"+webpath+"/skyadnin/files/update?dirCatch=true&status=A&removeFile="+removeFile+"&mp3tags="+mp3tags+"&url_path="+id+"&category_id="+cid+"&rename_file_name"+newName);
				ajaxRequest1.open("GET", "http://"+webpath+"/skyadnin/files/update?dirCatch=true&urlType=CopyToServer&status=A&removeFile="+removeFile+"&mp3tags="+mp3tags+"&url_path="+id+"&category_id="+cid+"&rename_file_name="+newName, true);
		...
		function clearcache(){
			//alert(category);
				...
				ajaxRequest1.open("GET", "http://"+webpath+"/skyadnin/category/clearcache?id="+cid, true);
				ajaxRequest1.send(null);
		}
...
elseif($files || $dirs){
	...
	<?php echo label_for('',radiobutton_tag('mp3tags','yes',true).'yes').'&nbsp;&nbsp;'; ?>
