...
*/
	...
	*/
	public static function removeAllFiles($id){
	    ...
	    */
		...
		sfToolkit::clearGlob(sfConfig::get('sf_upload_dir').'/thumb/'.$thumbServer.'/*_'.$fileIds->getString(1).'.jpg');
	...
	*/
	public static function getCategoryPathById($id,$self=false){
	    ...
	    $categoryPath = '<a href="/skyadnin/category/list">Home</a> &raquo; ';
	...
	*/
    ...
    $files = FilesPeer::retrieveByPk($fileId);
		...
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',70, 70, $wn, $hn, true, 'small_'.$files->getId().'.jpg',true,80,'logo.png');
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',110, 110, $wn, $hn, true, 'mid_'.$files->getId().'.jpg',true,80,'logo_v.png');
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',150, 150, $wn, $hn, true, 'thumb_'.$files->getId().'.jpg',true,80,'logo_v.png');
		}
	}
    ...
    $files = FilesPeer::retrieveByPk($fileId);
		...
		if(preg_match('/jpg|jpeg|png|gif/i',$teg)){
			...
			myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',70, 70, $w, $h, true, 'small_'.$files->getId().'.jpg',true,80,'logo.png');
			myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',110, 110, $w, $h, true, 'mid_'.$files->getId().'.jpg',true,80,'logo_v.png');
			myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',150, 150, $w, $h, true, 'thumb_'.$files->getId().'.jpg',true,80,'logo_v.png');
		}
	}
    ...
    $files = FilesPeer::retrieveByPk($fileId);
		...
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',70, 70, $w, $h, true, 'small_'.$files->getId().'.jpg',true,70,'logo.png');
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',110, 110, $w, $h, true, 'mid_'.$files->getId().'.jpg',true,70,'logo_v.png');
		myClass::getImageRatio($thumbName,'thumb/'.$thumbServer.'/',150, 150, $w, $h, true, 'thumb_'.$files->getId().'.jpg',true,70,'logo_v.png');
	}
