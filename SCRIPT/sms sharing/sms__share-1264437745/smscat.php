...
echo "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n";
	...
	$pg++;
	$cou=$lmt+1;
	$scount=MySQL_Fetch_Array(MySQL_Query("SELECT COUNT(*) FROM sites where cid='".$cid."' and banned='0'"));
	$pgs=Ceil($scount[0]/10);
	if($pgs=="0")$pgs="1";
	$sql="SELECT * FROM sites where cid='".$cid."' AND banned='0'  ORDER BY id DESC LIMIT ".$lmt.", 10;";
...
echo "<a href=\"sms:?body=".$snm.$by.$dscr .$bys."\">Forward</a><hr>";
	...
	if(1<$pgs)
	{
		...
		if($pg>1){$pp1=$pg-1;echo"<span class=\"pages\"><a href=\"smscat.php?cid=$cid&amp;$pp1&amp;more=$more&amp;uid=$uid&af=$pwd\"><</a></span>";}
