...
$sql="SELECT * FROM sites where banned='0' AND id >='0' ORDER BY id DESC LIMIT ".$lmt.", 20;";
...
echo "<a href=\"20sms.php?more=0&amp;cid=$cid&amp;pg=$pg\">Copy SMS Off</a>";
...
{
echo "<a href=\"".$self."?more=1&amp;pg=".$pg."\">Copy SMS</a><br/>";
}
$by ="  by-";
