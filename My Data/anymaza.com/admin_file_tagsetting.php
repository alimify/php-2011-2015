...
print '<title>Tag Setting</title><form action="" method="post"><br/><b>Album </b><br/><input type="text" name="album" value="'.$galbum.'"/><br/><b>Artist </b><br/><input type="text" name="artist" value="'.$gartist.'"/><br/><b>Image </b><br/><input type="text" name="image" value="'.$gimage.'"/><br/><b>Year </b><br/><input type="text" name="year" value="'.$gyear.'"/><br/><input type="hidden" name="dir" value="'.$dir.'"/><input type="submit" name="Submit" value="submit"/></form>';

}
print '<br/><a href="admin_file_albummp3.php?dir='.$dir.'">Back To Upload</a>';
