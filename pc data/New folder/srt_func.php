...
function nav_page($countstr,$fldid,$seotitle,$sort,$page,$dir,$p,$main)
{
...
break;
if($page!=$i)
$list.='<a href="http://anymaza.com/srt/pgn/'.$fldid.'/'.$seotitle.'/'.$sort.'/'.$i.'.html">'.($i+1).'</a> ';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://anymaza.com/srt/pgn/'.$fldid.'/'.$seotitle.'/'.$sort.'/'.$n.'.html">'.($n+1).'</a> ';
else
$list.=($n+1).'|';
}
$next=$n;
...
function nav_pagetxt($countstr,$fldid,$seotitle,$sort,$page,$dir,$p,$main)
{
$list='Page '.($page+1).' of '.$countstr.'<br />';
for($i=0; $i<3; $i++)
{
...
break;
if($page!=$i)
$list.='<a href="http://anymaza.com/srt/pgn/'.$fldid.'/'.$seotitle.'/'.$sort.'/'.($i+1).'.html">'.($i+1).'</a> ';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://anymaza.com/srt/pgn/'.$fldid.'/'.$seotitle.'/'.$sort.'/'.($n+1).'.html">'.($n+1).'</a> ';
else
$list.=($n+1).'|';
}
$next=$n;
