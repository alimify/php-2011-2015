...
<meta name="distribution" content="global"/><meta name="Identifier-URL" content="http://www.anymaza.com"/><meta http-equiv="Cache-control" content="no-cache"><link rel="shortcut icon" href="http://www.bollyclassic.com/uploads/favicon.ico"/><link rel="stylesheet" href="/css/style.css" type="text/css" />
</head>
<body>
...
$bd = mysql_query("SELECT * FROM folder GROUP BY folderurl ORDER BY folderid DESC") 
  or die(mysql_error());  
...
print '<div class="title" align="center">Latest Uploaded</div>';
 $getdata = mysql_query("SELECT * FROM folder GROUP BY folderurl ORDER BY folderid DESC $limit") 
  or die(mysql_error());
 ...
 //Foldername 
$folderif = basename($link);
$foldername=$folderif;
$foldercf = dirname($link);
$folderg=MySQL_Fetch_Array(MySQL_Query("SELECT folderid from folder where folderurl='".$foldercf."';"));
print '<div class="file"><a href="/'.$id.'/'.$foldername.'.html">'.$foldername.'</a></div>';
