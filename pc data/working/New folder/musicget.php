...
if($r == 'mp3'){print '<title>'.$title.''.$artist.'full mp3 song free Download - AnyMaza.Com</title>';
...
print '<div class="tags" align="center"><h2><b>Tags : </b>'.$descriptions.' '.$title.' itunerip,'.$title.' itunes download,'.$title.' 128kbps,'.$title.'64kbps,'.$title.' 320kbps'.$title.' 160kbps,'.$title.' 192kbps,'.$title.' mp3 songs</h2></div>';
