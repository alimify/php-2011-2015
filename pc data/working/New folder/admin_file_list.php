...
print '<center><a href="/admin_desc_edit.php?folderid='.$fldid.'">Description</a> | <a href="/admin_file_imageurl.php?folderid='.$fldid.'">Thumb</a></center>';
if($sort)
...
{print '<div class="fl odd"><a href="http://anymaza.com/'.$glob_file[$i].'"><b>'.$title.'</b></a><br/><font color="black"><small>File Size : '.$filesize.'</small></font><a href="/admin_file_rename.php?fileid='.$fileid[0].'">R</a> [<a href="/admin_lyricsadd.php?fileid='.$fileid[0].'">L</a>]</div>';
}
