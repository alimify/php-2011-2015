...
print '<div class="smsbox"><div class="sms">'.$cou.' ) '.$smsview[0].'</div><div class="share"><a href="/edits/'.$cid.'/'.$smsid.'/'.$pg.'.html"><b>E</b></a> | <a href="/like/'.$cid.'/'.$smsid.'/'.$pg.'.html">Like</a> - '.$like.' | <a href="/dlts/'.$cid.'/'.$smsid.'/'.$pg.'.html">X</a></div></div>';		
		$cou++;
	}
echo '<div class="paging">';
   ...
   if(1<$pgs)
	{   if($pre>0){print '<a href="/adminlist-j+z.php?cid='.$cid.'&page='.$prev.'">Prev</a>';}else{print '<b>Prev</b>';}
		...
		if($pg<=$pgs-1){$np3=$pg+3;echo"<a href=\"adminlist-j+z.php?cid=$cid&page=$np3\">$np3</a>";}
