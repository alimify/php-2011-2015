...
print '<br/>'.$when.'<div class="sms">'.$smsview[0].'</div><div class="user">Posted By <a href="/profile/'.$uid[0].'"><b>'.$unm[0].'</b></a> In <a href="/bangla-sms/'.$namesa.'-'.$cid.'">'.$name[0].'</a></div><div class="textarea"><textarea>'.$smsview[0].'</textarea></div>';
print 'Share By : <a href="sms:?body='.$smstrs.'">Sms</a>| Fb | twit | gplus';
echo '</div>';
echo '</div>';
///Return Function
