...
print '<title>'.$pagetitle.'</title><meta name="description" content="'.$pagedescript.''.$page.''.$pag.'"/><meta name="keywords" content="'.$keyseo[0].' ,'.$keyseo[1].',বাংলা,bangla,bengali,bd,new,এস এম এস,এসএমএস,in,language,www.,.com,মেসেজ,2015,বানী,kobita,'.$keyseo[3].','.$page.''.$pag.'">';
include 'css.php';
print '</head><body>';
include("head.php");
print '<div class="h1"><h1>'.$catnm[0].' '.$page.'</h1></div>';
...
if(!$mysql_status){print '<h2>bd '.$catnm[0].' bd,bengali bangla '.$catnm[0].''.$page.''.$pag.',বাংলা এস এম এস</h2>';}
include("foot.php");
print $foot;
?>