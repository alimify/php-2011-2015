...
function nav_page($countstr,$page,$dir,$fldid,$seotitle,$main)
{
...
break;
if($page!=$i)
$list.='<a href="http://anymaza.com/pgn/'.$fldid.'/'.$seotitle.'/'.$i.'.html">'.($i+1).'</a> ';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://anymaza.com/pgn/'.$fldid.'/'.$seotitle.'/'.$n.'.html">'.($n+1).'</a> ';
else
$list.=($n+1).'|';
}
$next=$n;
...
break;
if($page!=$i)
$list.='<a href="http://anymaza.com/pgn/'.$fldid.'/'.$seotitle.'/'.($i+1).'.html">'.($i+1).'</a> ';
else
$list.=($i+1).'|';
}
if($countstr>3)
...
continue;
if($page!=$n)
$list.='<a href="http://anymaza.com/pgn/'.$fldid.'/'.$seotitle.'/'.($n+1).'.html">'.($n+1).'</a> ';
else
$list.=($n+1).'|';
}
$next=$n;
