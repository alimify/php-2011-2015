...
$pg= $_GET['page'];
print '<html><head><link rel="stylesheet" href="/m.css" type="text/css" /><title>Top SMS :: WapSmsBD.Com</title></head><body>';
include("head.php");
...
echo '<div class="paging">';
   ...
   if(1<$pgs)
	{   if($pre>0){print '<a href="/topsms/'.$prev.'.html">Prev</a>';}else{print '<b>Prev</b>';}
		...
		if($pg<=$pgs-1){$np3=$pg+1;echo"<a href=\"/topsms/$np3.html\">$np3</a>";}
