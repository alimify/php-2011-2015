...
<meta name="viewport" content="width=device-width,initial-scale=1.0; maximum-scale=1.0;"/><link rel="stylesheet" href="/m.css" type="text/css"/><title>Jokes Editing :: WapSmsBD.Com</title></head>';
echo '<body>';
print '<div class="logo" align="left"><div><a href="/"><font size="5" color="white">WapSmsBD.Com</font></a></div></div>';
print '<div class="h1">Edit Jokes</div>';
echo '<div class="box">';
...
$d_open = fopen("extra/JokesTxt/jid_$sid.txt","w+");
...
print '<form action="" method="post">Jokes Edit : <br/><input type="hidden" name="gid" value="'.$sid.'"><textarea name="lyrics" cols=40 rows=6>';

$dfile = file("extra/JokesTxt/jid_$sid.txt");
/// Get Data
...
print '<form action="" method="post"><input type="hidden" name="gid" value="'.$sid.'">Category Name :<br/><input type="text" name="album" value="'.urldecode($sqlalbum[0]).'"><br/><input type="submit" name="SubmitAlbum" value="Edit"></form>';

print '<form action="" method="post"><input type="hidden" name="gid" value="'.$sid.'">Adult ? (1) : <br/><input type="text" name="singer" value="'.$sqlsinger[0].'"><br/><input type="submit" name="SubmitSinger" value="Edit"></form>';
