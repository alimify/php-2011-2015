...
require 'func_s.php';
print '<html><head><link rel="stylesheet" href="/m.css" type="text/css"/><title>Post New Jokes :: WapSmsBD.Com</title></head>';
echo '<body>';
print '<div class="logo" align="left"><div><a href="/"><font size="5" color="white">WapSmsBD.Com</font></a></div></div>';
print '<div class="h1">Add Jokes</div>';
echo '<div class="box">';
...
$res = mysql_query("INSERT INTO extra SET uid='".$mysql_id."', entitle='".$entitle."',bntitle='".$bntitle."',album='".$album."',singer='".$singer."',tags='".$tags."', type='2'");
...
$d_open = fopen("extra/JokesTxt/jid_$stid[0].txt","w+");
...
print '<center><form action="" method="post">Jokes : <br/><textarea name="lyrics"></textarea><br/>English Title : <br/><input type="text" name="entitle"><br/>Bangla Title : <br/><input type="text" name="bntitle"><br/>Category Name :<br/><input type="text" name="album"><br/>Adult ? (1) : <br/><input type="text" name="singer"><br/>Tags : <br/><textarea name="tags"></textarea><br/><input type="submit" name="Submit"></form></center>';
}
echo '</div>';
