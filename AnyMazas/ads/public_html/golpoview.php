...
print $top;
print '<title>Bangla Golpo - '.$entitle.' - Bengali Golpo</title><meta name="description" content="'.$description.'"/><meta name="keywords" content="'.$description.'">';
include 'css.php';
print '</head><body>';
include 'head.php';
print '<h1>'.$bntitle.'</h1>';
print '<div class="box">';
if($mysql_id=='1'){print '<center><a href="/golpoedit.php?sid='.$id.'"><b>Editing</b></a></center>';}

print '<h2>'.$entitle.' bangla bengali golpo '.$album.',
'.$bntitle.' বাংলা গল্প</h2>'; 

print '<div class=""><a href="/"><b>Home</b></a> » <a href="/bangla_golpos"><b>Bangla Golpo</b></a> »  <a href=""><b>'.$entitle.'</b></a></div>';


print '<div class="smsbox">';

print '<div class="info">নাম : <em>'.$album.'</em><br/>লেখক : <em>'.$singer.'</em></div><br/><strong>'.$entitle.' Bangla Golpo</strong><br/>';
$dfile = file("extra/golpoTxt/gid_$id.txt");
