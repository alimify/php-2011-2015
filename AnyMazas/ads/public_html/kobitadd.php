...
<meta name="viewport" content="width=device-width,initial-scale=1.0; maximum-scale=1.0;"/><link rel="stylesheet" href="/m.css" type="text/css"/><title>Post New Kobita :: WapSmsBD.Com</title></head>';
echo '<body>';
print '<div class="logo" align="left"><div><a href="/"><font size="5" color="white">WapSmsBD.Com</font></a></div></div>';
print '<div class="h1">Add Kobita</div>';
echo '<div class="box">';
...
$res = mysql_query("INSERT INTO extra SET uid='".$mysql_id."', entitle='".$entitle."',bntitle='".$bntitle."',album='".$album."',singer='".$singer."',tags='".$tags."', type='4'");
...
$d_open = fopen("extra/kobitaTxt/kid_$stid[0].txt","w+");
$lwrite=fwrite($d_open, $lyrics);
$lclose=fclose($d_open);
if($lwrite && $lclose){print '<center><font color="green">Successfully Added !</font><br/><a href="/kobitaedit.php?sid='.$stid[0].'"><b>Editing</b></a></center>';}	
...
print '<center><form action="" method="post">Kobita : <br/><textarea name="lyrics"></textarea><br/>English Title : <br/><input type="text" name="entitle"><br/>Bangla Title : <br/><input type="text" name="bntitle"><br/>Name :<br/><input type="text" name="album"><br/>Writter : <br/><input type="text" name="singer"><br/>Tags : <br/><textarea name="tags"></textarea><br/><input type="submit" name="Submit"></form></center>';
}
echo '</div>';
