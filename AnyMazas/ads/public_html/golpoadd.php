...
<meta name="viewport" content="width=device-width,initial-scale=1.0; maximum-scale=1.0;"/><link rel="stylesheet" href="/m.css" type="text/css"/><title>Post New Golpo :: WapSmsBD.Com</title></head>';
echo '<body>';
print '<div class="logo" align="left"><div><a href="/"><font size="5" color="white">WapSmsBD.Com</font></a></div></div>';
print '<div class="h1">Add Golpo</div>';
echo '<div class="box">';
...
$res = mysql_query("INSERT INTO extra SET uid='".$mysql_id."', entitle='".$entitle."',bntitle='".$bntitle."',album='".$album."',singer='".$singer."',tags='".$tags."', type='3'");
...
$d_open = fopen("extra/golpoTxt/gid_$stid[0].txt","w+");
$lwrite=fwrite($d_open, $lyrics);
$lclose=fclose($d_open);
if($lwrite && $lclose){print '<center><font color="green">Successfully Added !</font><br/><a href="/golpoedit.php?sid='.$stid[0].'"><b>Editing</b></a></center>';}	
