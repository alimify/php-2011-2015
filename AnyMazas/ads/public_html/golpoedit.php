...
<meta name="viewport" content="width=device-width,initial-scale=1.0; maximum-scale=1.0;"/><link rel="stylesheet" href="/m.css" type="text/css"/><title>Golpo Editing :: WapSmsBD.Com</title></head>';
echo '<body>';
print '<div class="logo" align="left"><div><a href="/"><font size="5" color="white">WapSmsBD.Com</font></a></div></div>';
print '<div class="h1">Edit Golpo</div>';
echo '<div class="box">';
...
$d_open = fopen("extra/golpoTxt/gid_$sid.txt","w+");
$lwrite=fwrite($d_open, $lyrics);
$lclose=fclose($d_open);
if($lwrite && $lclose){print '<font color="green">Golpo Edited Successfully !</font>';}
...
print '<form action="" method="post">Golpo Edit : <br/><input type="hidden" name="gid" value="'.$sid.'"><textarea name="lyrics" cols=40 rows=6>';

$dfile = file("extra/golpoTxt/gid_$sid.txt");
/// Get Data
