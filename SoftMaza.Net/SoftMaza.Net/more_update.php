...
//Mulai data reply
if ($pass == $adminpass) {
//echo '&nbsp; &nbsp;<a href="http://mixbd.com/update_del.php?a=hapus_teman&amp;nom='.$up.'&amp;pass='.$pass.'">Delete</a> | | <a href="http://mixbd.com/update_edit.php?b=gb&amp;nom='.$up.'&amp;pass='.$pass.'">Edit</a><br/>';
}
...
echo '';
if ($pass == $adminpass) {
//echo '&raquo; <a href="http://mixbd.com/teman.php?pass='.$pass.'">Post New Updates</a><br/>';
