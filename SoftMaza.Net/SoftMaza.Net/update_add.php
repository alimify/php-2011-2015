...
<html>
<head>
<title>Latest Updates | SoftMaza.Net</title>
...
echo'<h2>
<center><b>Latest Updates</b></center></h2>';
...
&raquo; <a href="update_add.php?a=login">Try again</a><br/>';
} else {
echo 'Login success !! <br/>
&raquo; <a href="update_add.php?pass='.$adminpass.'">Enter Cpanel</a><br/>';
}
break;
default:
echo '<form action="update_add.php?a=login&amp;m=panel" method="post">
Admin Password :<br/>
...
break;
default:
echo '<form action="update_add.php?a=edit&amp;e=simpan&amp;pass='.$pass.'" method="post">
Nama site :<br/>
...
//Mulai data reply
if ($pass == $adminpass) {
echo '&nbsp; &nbsp;<a href="http://SoftMaza.Net/update_del.php?a=hapus_teman&amp;nom='.$up.'&amp;pass='.$pass.'">Delete</a> <br/>';
}
echo "";
}
}
...
if ($page < $all){
if ($pass == $adminpass){
echo " <b>[<a href=\"./update_add.php?pass=".$pass."&amp;page=".($page +1)."\">&gt;&gt;</a>]</b>";
} else {
echo " <b>[<a href=\"./update_add.php?page=".($page +1)."\">&gt;&gt;</a>]</b>";
}
}
else {
}
...
if ($pass == $adminpass) {
echo '&raquo; <a href="http://SoftMaza.Net/teman.php?pass='.$pass.'">Post New Updates</a><br/>';
